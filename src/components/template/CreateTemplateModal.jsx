    ...
    shouldRender && (
      ...
      >
        ...
        <form
          ...
          className={`relative z-10 w-full max-w-xl transform-gpu rounded-2xl border border-zinc-800 bg-zinc-950 p-5 shadow-[0_30px_90px_rgba(0,0,0,0.55)] transition-all duration-200 ease-out ${
